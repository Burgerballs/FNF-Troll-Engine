...
class KeyBindsSubstate extends MusicBeatSubstate  {
	...
	override public function create()
	{
		...
		var optionMenu = new FlxSprite(84, 80, CoolUtil.makeOutlinedGraphic(920, 570, 0xFF000000, 2, 0xFF000000));
